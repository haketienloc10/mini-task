...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/locdt/Notes/VSCode/mini-task/.codex/.gsd-surface.json`
(sibling to `/home/locdt/Notes/VSCode/mini-task/.codex/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/locdt/Notes/VSCode/mini-task/.codex/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/locdt/Notes/VSCode/mini-task/.codex/skills`).
...
`/home/locdt/Notes/VSCode/mini-task/.codex/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/locdt/Notes/VSCode/mini-task/.codex/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/locdt/Notes/VSCode/mini-task/.codex/.gsd-surface.json`
Install profile marker: `/home/locdt/Notes/VSCode/mini-task/.codex/.gsd-profile`
Skill dirs: `/home/locdt/Notes/VSCode/mini-task/.codex/skills/gsd-*/`
Engine module: `/home/locdt/Notes/VSCode/mini-task/.codex/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/home/locdt/Notes/VSCode/mini-task/.codex/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
