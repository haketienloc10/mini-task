...
<reference>
@/home/locdt/Notes/VSCode/mini-task/.codex/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/locdt/Notes/VSCode/mini-task/.codex/get-shit-done/references/user-profiling.md` to load:
