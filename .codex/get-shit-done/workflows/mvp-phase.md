...
<required_reading>
@/home/locdt/Notes/VSCode/mini-task/.codex/get-shit-done/references/user-story-template.md
@/home/locdt/Notes/VSCode/mini-task/.codex/get-shit-done/references/spidr-splitting.md
@/home/locdt/Notes/VSCode/mini-task/.codex/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/home/locdt/Notes/VSCode/mini-task/.codex/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/home/locdt/Notes/VSCode/mini-task/.codex/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@/home/locdt/Notes/VSCode/mini-task/.codex/get-shit-done/references/spidr-splitting.md`. Briefly:
