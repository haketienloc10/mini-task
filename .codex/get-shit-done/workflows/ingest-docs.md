...
```bash
INIT=$(node "/home/locdt/Notes/VSCode/mini-task/.codex/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/locdt/Notes/VSCode/mini-task/.codex/get-shit-done/bin/gsd-tools.cjs" commit \
