...
INSTALL_JS_GLOBAL="/home/locdt/Notes/VSCode/mini-task/.codex/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/locdt/Notes/VSCode/mini-task/.codex/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
