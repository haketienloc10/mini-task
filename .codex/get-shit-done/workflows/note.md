...
- **Global scope**: `/home/locdt/Notes/VSCode/mini-task/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/locdt/Notes/VSCode/mini-task/.codex/notes/`)
...
2. Glob `/home/locdt/Notes/VSCode/mini-task/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/home/locdt/Notes/VSCode/mini-task/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/locdt/Notes/VSCode/mini-task/.codex/notes/` — works in any directory
