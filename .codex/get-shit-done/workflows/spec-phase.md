...
```bash
INIT=$(node "/home/locdt/Notes/VSCode/mini-task/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/locdt/Notes/VSCode/mini-task/.codex/get-shit-done/templates/spec.md.
