...
```
Agent(
  prompt="Read /home/locdt/Notes/VSCode/mini-task/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/locdt/Notes/VSCode/mini-task/.codex/get-shit-done/templates/SECURITY.md`
